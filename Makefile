main: fileReader.o main.o client.o vehicle.o model.o graph.o heuristic.o twoOpt.o
	g++ main.o fileReader.o client.o vehicle.o model.o graph.o heuristic.o twoOpt.o -o main
